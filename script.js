...
const GOOGLE_API_KEY = "AIzaSyDYNcj1HAEiAAItc5ila3DukWg9MXj0EHw";
    ...
    savedConversations.forEach(conversation => {
        ...
        const userMessageHtml = `
            ...
            <div class="message__content">
                <img class="message__avatar" src="assets/captain.png" alt="User avatar">
        ...
        const responseHtml = `
           ...
           <div class="message__content">
                <img class="message__avatar" src="assets/logo.svg" alt="captain avatar">
